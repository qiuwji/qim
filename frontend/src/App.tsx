...
function ChatPage({ user, onUserChange, onLogout }: { user: import('./api/types').UserDTO; onUserChange: (u: import('./api/types').UserDTO) => void; onLogout: () => void }) {
  ...
  const {
    ...
    sendText, sendImage, searchUsers, startPrivate, createGroup, handleRequest,
  ...
  return (
    <main className={`im-shell ${detailOpen ? 'show-detail' : ''}`} onClick={() => { setContextMenu(null); setHoverCard(null); }}>
