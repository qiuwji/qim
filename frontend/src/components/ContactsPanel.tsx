    ...
    <div className="overflow-auto px-2 py-1" onClick={() => setFriendCtx(null)}>
      ...
      <div className="grid gap-0.5 border-b-8 border-[#f2f3f5] pt-1 pb-2">
        <button className={`${contactRow} rounded-none py-3`} onClick={() => toggle('notices')}>
          ...
          {noticeCount > 0 && <b className="grid h-[18px] min-w-[18px] place-items-center rounded-full bg-[#ff4d4f] px-1.5 text-[11px] text-white">{noticeCount > 99 ? '99+' : noticeCount}</b>}
        </button>
      ...
      {openSections.notices && <div className="border-b-8 border-[#f2f3f5] px-2 py-1">
      ...
      {openSections.groups && <div className="border-b-8 border-[#f2f3f5] px-2 py-1">
